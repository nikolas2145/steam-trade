module ConfirmationCommands
  ...
  def send_trade_allow_request(trade_id)
    ###FIRST
  ...
  def create_confirmation_params(tag_string)
    # FOURTH FINISHED
  ...
  def select_trade_offer_confirmation(trade_id, confirmations)
    ## seventh
  ...
  def fetch_confirmation_details_page(hash)
    ##eigth
    var = hash['id']
    tag = 'details' + var
